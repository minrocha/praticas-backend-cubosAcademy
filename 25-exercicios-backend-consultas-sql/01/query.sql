...
select composicao, tempo from musicas where tempo > 280;
...
select * from musicas where compositor is not null and compositor != 'Bach';
...
select composicao, tempo from musicas where compositor = 'Mozart' and compositor = 'Bach';
